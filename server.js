...
mongoose.connect(mongoURI).then(() => console.log("✅ Payroll System Online"));
...
app.post("/calculate", async (req, res) => {
    try {
        ...
        const gross = actualBasic + d.transport + d.special + d.comm;
        const fullGrossForSI = d.basic + d.transport + d.special + d.comm;
        const insurance = R(Math.min(fullGrossForSI, 16700) * 0.11);
