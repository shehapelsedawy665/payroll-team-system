...
type Company struct {
	...
	AdminEmail         string             `bson:"adminEmail" json:"adminEmail"` // البريد الخاص بالمدير
	Email              string             `bson:"email" json:"email"`           // بريد الشركة
	Password           string             `bson:"password" json:"password"`     // تم التعديل لضمان وصولها للسيرفر أثناء التسجيل
